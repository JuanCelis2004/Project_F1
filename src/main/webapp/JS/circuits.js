  ...
  rows.forEach((c) => {
    ...
    el.innerHTML = `
      ...
      <div>
        ...
        <div class="kpis">
          <div class="kpi"><small>Longitud</small><b>${km(
            c.lengthKm
          )} km</b></div>
          <div class="kpi"><small>Vueltas</small><b>${c.laps}</b></div>
          <div class="kpi"><small>Distancia</small><b>${totalDistance(
            c
          )} km</b></div>
        </div>
      </div>
